...
**Usage:**
```bash
bash /Users/v36372/.pi/agent/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash /Users/v36372/.pi/agent/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
