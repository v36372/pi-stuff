...
6. Check if packages/coding-agent/README.md, packages/coding-agent/docs/_.md, packages/coding-agent/examples/\**/_.md require modification. This is usually the case when existing features have been changed, or new features have been added.
