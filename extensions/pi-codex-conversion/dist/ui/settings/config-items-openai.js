import { DEFAULT_CODEX_CONVERSION_CONFIG, normalizeCodexVerbosity, normalizeV2UserMessageRetention, V2_USER_MESSAGE_RETENTION_OPTIONS, } from "../../adapter/activation/config.js";
import { setting, toggle } from "./config-items-shared.js";
export function buildOpenAISettings(config, theme) {
    return [
        ...
        toggle("responsesLite", "Proxy Responses Lite", config.beta.responsesLite, (enabled, current) => ({
            ...current,
        ...
        toggle("responsesCompaction", "Responses compaction V2", config.compaction.responsesCompaction, (enabled, current) => ({
            ...current,
