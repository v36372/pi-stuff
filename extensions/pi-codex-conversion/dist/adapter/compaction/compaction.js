...
import { createNativeCompactionDetails, createNativeCompactionShimResult, NATIVE_COMPACTION_SHIM_SUMMARY } from "../compaction/types.js";
...
async function handleCodexSessionBeforeCompactInner(event, ctx, state, pi) {
    ...
    const compactedWindow = buildRemoteCompactionV2Window(input, compactResult.compaction, (state.config.beta.v2UserMessageRetention ?? 64) * 1_000);
    try {
