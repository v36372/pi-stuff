...
export function registerCodeModeEvents(pi, runtime) {
    ...
    pi.on("before_agent_start", (event, ctx) => {
        ...
        runtime.setPromptSection(buildCodeModeToolsPrompt(promptTools, documentationPath, event.systemPrompt));
        const systemPrompt = injectCodeModeToolsPrompt(event.systemPrompt, promptTools, documentationPath);
