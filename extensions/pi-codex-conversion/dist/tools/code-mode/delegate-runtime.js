...
export class CodeModeDelegateRuntime {
    ...
    async invoke(message, controller) {
        ...
        const trace = this.traces.start(cellId, String(invocation?.runtime_tool_call_id ?? message.id), tool.name, input);
