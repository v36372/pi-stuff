...
function renderVoiceStartupContext(summary) {
    return `${VOICE_STARTUP_CONTEXT_HEADER}\n<startup_context>\n${summary}\n</startup_context>`;
}
async function createVoiceContextSummary(ctx, selected, reasoning, signal) {
...
function latestCompactionIsOpaque(ctx) {
...
function voiceContextCacheKey(ctx, model, reasoning) {
