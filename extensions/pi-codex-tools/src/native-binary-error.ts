const RECOVERY =
	"This binary is incompatible with this system (loader/GLIBC). Rebuild apply_patch and exec_bridge for this target from upstream pi-codex-conversion sources, set tools.customRustBinariesDir in pi-codex-tools.json, then /reload. Upstream prebuilts will not fix ABI mismatches";
